...
proc derive_parameters {param_array} {
    ...
    set_shell_parameter DRV_DDR_PRESET_FILE    ""
...
proc transfer_files {} {
    ...
    set v_ddr_preset_file       [get_shell_parameter DRV_DDR_PRESET_FILE]
    ...
    file_copy   ${v_subsys_dir}/boards/AGX_3C_Devkit/board_subsystem.qsf.terp \
                ${v_project_path}/quartus/shell/${v_instance_name}.qsf.terp

    file_copy   ${v_subsys_dir}/boards/AGX_3C_Devkit/board_subsystem.sdc.terp \
                ${v_project_path}/sdc/shell/${v_instance_name}.sdc.terp

    # copy Top level RTL files
    file_copy   ${v_subsys_dir}/boards/AGX_3C_Devkit/top.v.terp \
    ...
    foreach v_bank ${v_drv_ddr_enabled_banks} {
        ...
        set v_ddr_preset_file [get_shell_parameter LPDDR4_PRESET_${v_bank}_FILE]

        file_copy   ${v_subsys_dir}/boards/AGX_3C_Devkit/${v_ddr_preset_file} \
    ...
    file_copy   ${v_subsys_dir}/boards/AGX_3C_Devkit/jtag.sdc \
...
proc edit_top_v_file {} {
    ...
    foreach v_bank ${v_drv_ddr_enabled_banks} {
        ...
        set v_ca_width_max  [expr ${v_ca_width}-1]
        set v_dmi_width_max [expr ${v_dmi_width}-1]
        ...
        add_top_port_list output   "\[ 0:0\]"                   "${v_bank_lower}_mem_cs"
        add_top_port_list output   "\[ ${v_ca_width_max}:0\]"   "${v_bank_lower}_mem_ca"
        ...
        add_top_port_list inout    "\[${v_dmi_width_max}:0\]"   "${v_bank_lower}_mem_dmi"
    }
