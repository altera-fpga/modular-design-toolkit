...
set_shell_parameter HPS_AI_BBF                          {0}
set_shell_parameter HPS_AXI_CLK                         {100000000}

set_shell_parameter MSGDMA_AGENT                        {}
set_shell_parameter MSGDMA_IRQ_PRIORITY                 {X}

set_shell_parameter F2H_EN                              {0}
set_shell_parameter CAM_I2C_EN                          {0}
...
proc derive_parameters {param_array} {
  ...
  set v_msgdma_irq_priority   [get_shell_parameter MSGDMA_IRQ_PRIORITY]

  set v_internal_priorities []

  if {${v_msgdma_en}} {
    lappend v_internal_priorities $v_msgdma_irq_priority
  }
  ...
  foreach priority ${v_lw_external_priorities} {
    lappend v_external_priorities $priority
  }
...
proc transfer_files {} {
  ...
  if {${v_library_dir}!=""} {
    ...
    foreach path ${v_library_dir} {
      file_copy ${path} ${v_project_path}/software/${v_instance_name}/lib
    }
  }
  ...
  if {${v_include_dir}!=""} {
    ...
    foreach path ${v_include_dir} {
      file_copy ${path} ${v_project_path}/software/${v_instance_name}/app/inc
    }
  }
  if {${v_source_dir}!=""} {
    file mkdir ${v_project_path}/software/${v_instance_name}/app/

    foreach path ${v_source_dir} {
      file_copy ${path} ${v_project_path}/software/${v_instance_name}/app/
    }
  }
...
proc create_cpu_subsystem {} {
  ...
  set v_drv_ddr_preset          [get_shell_parameter DRV_DDR_PRESET]
  ...
  # Bounding Box Frame
  set v_hps_ai_bbf              [get_shell_parameter HPS_AI_BBF]
  set v_cam_i2c_en              [get_shell_parameter CAM_I2C_EN]
  ...
  if {${v_quartus_version} >= 24.3} {
    ...
    add_instance  emif_agilex_hps                           emif_hps_ph2
  }
  ...
  set_instance_parameter_value agilex_hps FPGA_I2C0_sclk_mhz         {125.0}
  set_instance_parameter_value agilex_hps FPGA_I2C1_sclk_mhz         {100.0}
  ...
  set_instance_parameter_value agilex_hps I2CEMAC1_Mode             {N/A}
  set_instance_parameter_value agilex_hps I2CEMAC1_PinMuxing        {Unused}
  ...
  if {(${v_quartus_version} >= 24.3) && (${v_emac2_txrx_clk_delay_en} == 1)} {
  ...
  if {${v_quartus_version} >= 24.2} {
    # do nothing - the parameters in the else branch were removed in Quartus 24.2
  } else {
    set_instance_parameter_value agilex_hps MPU_core0_freq_override_mhz {1033.33}
    set_instance_parameter_value agilex_hps MPU_core1_freq_override_mhz {800.0}
  }
  ...
  if {${v_quartus_version} <= 24.2} {
    set_instance_parameter_value agilex_hps f2s_mode                      {axi4}
  }
  if {(${v_ai_en} == 0) || (${v_hps_ai_bbf} == 0)}                      {
    set_instance_parameter_value agilex_hps f2sdram_address_width       {32}
  } else {
    set_instance_parameter_value agilex_hps f2sdram_address_width       {36}
  }
  ...
  if {${v_quartus_version} >= 24.3} {
    ...
    set_instance_parameter_value emif_agilex_hps MEM_TECHNOLOGY_AUTO_BOOL       {0}
    set_instance_parameter_value emif_agilex_hps MEM_TECHNOLOGY                 {MEM_TECHNOLOGY_DDR4}
    set_instance_parameter_value emif_agilex_hps HPS_EMIF_CONFIG_AUTO_BOOL      {0}
    set_instance_parameter_value emif_agilex_hps HPS_EMIF_CONFIG                {HPS_EMIF_1x32}

    set_instance_parameter_value emif_agilex_hps MEM_FORMAT                     {MEM_FORMAT_DISCRETE}
    set_instance_parameter_value emif_agilex_hps MEM_TOPOLOGY                   {MEM_TOPOLOGY_FLYBY}
    set_instance_parameter_value emif_agilex_hps MEM_NUM_RANKS                  {1}
    set_instance_parameter_value emif_agilex_hps MEM_NUM_CHANNELS               {1}
    set_instance_parameter_value emif_agilex_hps MEM_DEVICE_DQ_WIDTH            {16}
    set_instance_parameter_value emif_agilex_hps MEM_COMPS_PER_RANK             {2}
    set_instance_parameter_value emif_agilex_hps MEM_AC_MIRRORING_AUTO_BOOL     {1}
    set_instance_parameter_value emif_agilex_hps CTRL_ECC_MODE_AUTO_BOOL        {1}
    set_instance_parameter_value emif_agilex_hps CTRL_ECC_MODE                  {CTRL_ECC_MODE_DISABLED}
    set_instance_parameter_value emif_agilex_hps PHY_ALERT_N_PLACEMENT          {PHY_ALERT_N_PLACEMENT_AC2}
    set_instance_parameter_value emif_agilex_hps USER_MIN_NUM_AC_LANES          {3}
    set_instance_parameter_value emif_agilex_hps PHY_MEMCLK_FREQ_MHZ_AUTO_BOOL  {0}
    set_instance_parameter_value emif_agilex_hps PHY_MEMCLK_FREQ_MHZ            {800.0}

    set_instance_parameter_value emif_agilex_hps MEM_PRESET_FILE_EN             {1}
    set_instance_parameter_value emif_agilex_hps MEM_PRESET_FILE_QPRS \
                        ${v_project_path}/non_qpds_ip/shell/${v_drv_ddr_preset_file}
    set_instance_parameter_value emif_agilex_hps MEM_PRESET_ID_AUTO_BOOL        {0}
    set_instance_parameter_value emif_agilex_hps MEM_PRESET_ID                  ${v_drv_ddr_preset}

    # advanced parameters

    set_instance_parameter_value emif_agilex_hps PHY_AC_PLACEMENT_AUTO_BOOL     {0}
    set_instance_parameter_value emif_agilex_hps PHY_AC_PLACEMENT               {PHY_AC_PLACEMENT_BOT}
    set_instance_parameter_value emif_agilex_hps PHY_REFCLK_FREQ_MHZ_AUTO_BOOL  {0}
    set_instance_parameter_value emif_agilex_hps PHY_REFCLK_FREQ_MHZ            {100.0}
    set v_board_name [get_shell_parameter DEVKIT]
    if {${v_board_name} == "AGX_5E_Si_Devkit"} {
        set_instance_parameter_value emif_agilex_hps PHY_REFCLK_FREQ_MHZ            {100.0}
    } elseif {${v_board_name} == "AGX_5E_Modular_Devkit"} {
        set_instance_parameter_value emif_agilex_hps PHY_REFCLK_FREQ_MHZ            {150.0}
    } else {
        set_instance_parameter_value emif_agilex_hps PHY_REFCLK_FREQ_MHZ            {100.0}
    }


    set_instance_parameter_value emif_agilex_hps GRP_PHY_AC_AUTO_BOOL         {1}
    set_instance_parameter_value emif_agilex_hps GRP_PHY_CLK_AUTO_BOOL        {1}

    set_instance_parameter_value emif_agilex_hps GRP_PHY_DATA_AUTO_BOOL       {1}

    set_instance_parameter_value emif_agilex_hps GRP_PHY_IN_AUTO_BOOL         {1}

    set_instance_parameter_value emif_agilex_hps GRP_MEM_ODT_DQ_AUTO_BOOL     {1}

    set_instance_parameter_value emif_agilex_hps GRP_MEM_DQ_VREF_AUTO_BOOL    {1}

    set v_quartus_version [get_shell_parameter QUARTUS_VERSION]

    if {(${v_quartus_version} >= 24.1) && (${v_board_name} == "AGX_5E_Si_Devkit")} {
        set_instance_parameter_value emif_agilex_hps USER_EXTRA_PARAMETERS  {BYTE_SWIZZLE_CH0=0,X,X,X,1,2,3,X;PIN_SWIZZLE_CH0_DQS0=0,2,6,4,1,3,5,7;PIN_SWIZZLE_CH0_DQS1=12,15,8,11,14,10,13,9;PIN_SWIZZLE_CH0_DQS2=20,16,18,22,23,17,19,21;PIN_SWIZZLE_CH0_DQS3=26,30,28,24,25,27,31,29;}

    } elseif {(${v_quartus_version} >= 24.1) && (${v_board_name} == "AGX_5E_Modular_Devkit")} {
        set_instance_parameter_value emif_agilex_hps USER_EXTRA_PARAMETERS  {BYTE_SWIZZLE_CH0=0,X,X,X,1,2,3,X;PIN_SWIZZLE_CH0_DQS3=26,30,28,24,25,27,29,31;PIN_SWIZZLE_CH0_DQS2=16,20,22,18,23,21,19,17;PIN_SWIZZLE_CH0_DQS1=14,11,12,8,10,9,13,15;PIN_SWIZZLE_CH0_DQS0=2,0,6,4,7,5,3,1;}
    } else {
        set_instance_parameter_value emif_agilex_hps USER_EXTRA_PARAMETERS  {BYTE_SWIZZLE_CH0=0,X,X,X,1,2,3,X;PIN_SWIZZLE_CH0_DQS0=0,2,6,4,1,3,5,7;PIN_SWIZZLE_CH0_DQS1=12,15,8,11,14,10,13,9;PIN_SWIZZLE_CH0_DQS2=20,16,18,22,23,17,19,21;PIN_SWIZZLE_CH0_DQS3=26,30,28,24,25,27,31,29;}
    }
  }
  ...
  if {(${v_ai_en} == 0) || (${v_hps_ai_bbf} == 0)} {
    ...
    add_instance  isp_ai_intel_vvp_vfr                   intel_vvp_vfr
    add_instance  isp_ai_intel_vvp_vfr_se                altera_address_span_extender

    set_instance_parameter_value isp_ai_vid_clk_bridge          EXPLICIT_CLOCK_RATE           {148500000.0}
    ...
    set_instance_parameter_value  isp_ai_intel_vvp_vfr          BPS                           {8}
    set_instance_parameter_value  isp_ai_intel_vvp_vfr          CLOCKS_ARE_SEPARATE           {1}
    set_instance_parameter_value  isp_ai_intel_vvp_vfr          C_OMNI_CAP_ID_ASSOCIATED      {0}
    set_instance_parameter_value  isp_ai_intel_vvp_vfr          C_OMNI_CAP_ID_COMPONENT       {1}
    set_instance_parameter_value  isp_ai_intel_vvp_vfr          C_OMNI_CAP_IRQ                {255}
    set_instance_parameter_value  isp_ai_intel_vvp_vfr          C_OMNI_CAP_IRQ_ENABLE         {0}
    set_instance_parameter_value  isp_ai_intel_vvp_vfr          C_OMNI_CAP_IRQ_ENABLE_EN      {0}
    set_instance_parameter_value  isp_ai_intel_vvp_vfr          C_OMNI_CAP_IRQ_STATUS         {0}
    set_instance_parameter_value  isp_ai_intel_vvp_vfr          C_OMNI_CAP_IRQ_STATUS_EN      {0}
    set_instance_parameter_value  isp_ai_intel_vvp_vfr          C_OMNI_CAP_TAG                {0}
    set_instance_parameter_value  isp_ai_intel_vvp_vfr          C_OMNI_CAP_TYPE               {586}
    set_instance_parameter_value  isp_ai_intel_vvp_vfr          C_OMNI_CAP_VERSION            {1}
    set_instance_parameter_value  isp_ai_intel_vvp_vfr          ENABLE_DEBUG                  {1}
    set_instance_parameter_value  isp_ai_intel_vvp_vfr          EXTERNAL_MODE                 {1}
    set_instance_parameter_value  isp_ai_intel_vvp_vfr          MAX_BUFFER_SETS               {2}
    set_instance_parameter_value  isp_ai_intel_vvp_vfr          MAX_HEIGHT                    {1080}
    set_instance_parameter_value  isp_ai_intel_vvp_vfr          MAX_WIDTH                     {1920}
    set_instance_parameter_value  isp_ai_intel_vvp_vfr          NUMBER_OF_COLOR_PLANES        {1}
    set_instance_parameter_value  isp_ai_intel_vvp_vfr          PACKING                       {PERFECT}
    set_instance_parameter_value  isp_ai_intel_vvp_vfr          PIXELS_IN_PARALLEL            {2}
    set_instance_parameter_value  isp_ai_intel_vvp_vfr          P_AV_MM_ADDR_WIDTH            {32}
    set_instance_parameter_value  isp_ai_intel_vvp_vfr          P_AV_MM_DATA_WIDTH            {256}
    set_instance_parameter_value  isp_ai_intel_vvp_vfr          READ_BURST_TARGET             {32}
    set_instance_parameter_value  isp_ai_intel_vvp_vfr          READ_FIFO_DEPTH               {256}
    set_instance_parameter_value  isp_ai_intel_vvp_vfr          SEPARATE_SLAVE_CLOCK          {1}
    set_instance_parameter_value  isp_ai_intel_vvp_vfr          SLAVE_PROTOCOL                {Avalon}

    set_instance_parameter_value  isp_ai_intel_vvp_vfr_se       BURSTCOUNT_WIDTH              {6}
    set_instance_parameter_value  isp_ai_intel_vvp_vfr_se       DATA_WIDTH                    {256}
    set_instance_parameter_value  isp_ai_intel_vvp_vfr_se       ENABLE_SLAVE_PORT             {1}
    set_instance_parameter_value  isp_ai_intel_vvp_vfr_se       MASTER_ADDRESS_DEF            {36507222016}
    set_instance_parameter_value  isp_ai_intel_vvp_vfr_se       MASTER_ADDRESS_WIDTH          {36}
    set_instance_parameter_value  isp_ai_intel_vvp_vfr_se       MAX_PENDING_READS             {8}
    set_instance_parameter_value  isp_ai_intel_vvp_vfr_se       SLAVE_ADDRESS_WIDTH           {26}
    set_instance_parameter_value  isp_ai_intel_vvp_vfr_se       SUB_WINDOW_COUNT              {1}
    set_instance_parameter_value  isp_ai_intel_vvp_vfr_se       SYNC_RESET                    {0}

    add_connection  isp_ai_vid_clk_bridge.out_clk           isp_ai_vid_rst_bridge.clk
    add_connection  isp_ai_vid_clk_bridge.out_clk           isp_ai_intel_vvp_vfr.main_clock
    add_connection  isp_ai_vid_rst_bridge.out_reset         isp_ai_intel_vvp_vfr.main_reset
    # as per hps popup
    add_connection  agilex_hps.h2f_reset                    isp_ai_intel_vvp_vfr_se.reset

    add_connection  hps_axi_clk_bridge.out_clk              isp_ai_intel_vvp_vfr_se.clock
    add_connection  hps_axi_rst_bridge.out_reset            isp_ai_intel_vvp_vfr_se.reset

    add_connection  hps_axi_clk_bridge.out_clk              isp_ai_intel_vvp_vfr.control_clock
    add_connection  hps_axi_rst_bridge.out_reset            isp_ai_intel_vvp_vfr.control_reset
    add_connection  hps_axi_clk_bridge.out_clk              isp_ai_intel_vvp_vfr.mem_clock
    add_connection  hps_axi_rst_bridge.out_reset            isp_ai_intel_vvp_vfr.mem_reset

    add_connection   agilex_hps.hps2fpga/isp_ai_intel_vvp_vfr.av_mm_control_agent
    add_connection   agilex_hps.hps2fpga/isp_ai_intel_vvp_vfr_se.cntl

    add_connection  isp_ai_intel_vvp_vfr_se.expanded_master   agilex_hps.f2sdram

    add_connection  isp_ai_intel_vvp_vfr.av_mm_mem_read_host  isp_ai_intel_vvp_vfr_se.windowed_slave


    add_interface           ai_res_out_m_vid_axis       axi4stream  manager
    set_interface_property  ai_res_out_m_vid_axis       EXPORT_OF   isp_ai_intel_vvp_vfr.axi4s_vid_out

    set_interface_property  vfr_int                     EXPORT_OF   isp_ai_intel_vvp_vfr.frame_reader_int

    set_connection_parameter_value agilex_hps.hps2fpga/isp_ai_intel_vvp_vfr_se.cntl             baseAddress "0x04000100"
    set_connection_parameter_value agilex_hps.hps2fpga/isp_ai_intel_vvp_vfr.av_mm_control_agent baseAddress "0x04000400"

    lock_avalon_base_address  isp_ai_intel_vvp_vfr_se.cntl
    lock_avalon_base_address  isp_ai_intel_vvp_vfr.av_mm_control_agent
...
if {${v_quartus_version} >= 24.3} {
    ...
    add_connection  emif_agilex_hps.s0_axil_clk       agilex_hps.io96b0_csr_axi_clk
    add_connection  emif_agilex_hps.s0_axil_rst_n     agilex_hps.io96b0_csr_axi_rst
    add_connection  agilex_hps.io96b0_csr_axi         emif_agilex_hps.s0_axil

    add_connection  emif_agilex_hps.usr_clk_0         agilex_hps.io96b0_ch0_axi_clk
    add_connection  emif_agilex_hps.usr_rst_n_0       agilex_hps.io96b0_ch0_axi_rst
    add_connection  agilex_hps.io96b0_ch0_axi         emif_agilex_hps.s0_axi4
}
...
if {${v_quartus_version} >= 24.3} {
    ...
    add_interface           agilex_hps_emif_mem conduit end
    set_interface_property  agilex_hps_emif_mem EXPORT_OF emif_agilex_hps.emif_mem_0

    add_interface           agilex_hps_emif_oct conduit end
    set_interface_property  agilex_hps_emif_oct EXPORT_OF emif_agilex_hps.emif_oct_0

    add_interface           agilex_hps_emif_ref_clk clock sink
    set_interface_property  agilex_hps_emif_ref_clk EXPORT_OF emif_agilex_hps.emif_ref_clk_0
}
  ...
  if {${v_fpga_emif_enabled}} {
    ...
    add_instance  hps_address_span_extender       altera_address_span_extender
    add_instance  hps_fpga_emif_cc_bridge         mm_ccb

    set_instance_parameter_value    hps_address_span_extender    BURSTCOUNT_WIDTH       {1}
    set_instance_parameter_value    hps_address_span_extender    DATA_WIDTH             {128}
    set_instance_parameter_value    hps_address_span_extender    ENABLE_SLAVE_PORT      {1}
    set_instance_parameter_value    hps_address_span_extender    MASTER_ADDRESS_DEF     {0}
    set_instance_parameter_value    hps_address_span_extender    MASTER_ADDRESS_WIDTH   $v_fpga_emif_host_addr_width
    set_instance_parameter_value    hps_address_span_extender    MAX_PENDING_READS      {1}
    set_instance_parameter_value    hps_address_span_extender    SLAVE_ADDRESS_WIDTH    $v_fpga_emif_agent_addr_width
    set_instance_parameter_value    hps_address_span_extender    SUB_WINDOW_COUNT       {1}
    set_instance_parameter_value    hps_address_span_extender    SYNC_RESET             {0}
    ...
    add_connection   hps_axi_clk_bridge.out_clk                  hps_address_span_extender.clock
    add_connection   hps_axi_clk_bridge.out_clk                  hps_fpga_emif_cc_bridge.s0_clk

    add_connection   hps_axi_rst_bridge.out_reset                hps_address_span_extender.reset
    add_connection   hps_axi_rst_bridge.out_reset                hps_fpga_emif_cc_bridge.s0_reset

    add_connection   hps_address_span_extender.expanded_master   hps_fpga_emif_cc_bridge.s0

    add_connection   agilex_hps.hps2fpga                         hps_address_span_extender.windowed_slave
    add_connection   agilex_hps.hps2fpga                         hps_address_span_extender.cntl

    add_interface           fpga_emif_clock   clock         sink
    set_interface_property  fpga_emif_clock   EXPORT_OF     hps_fpga_emif_cc_bridge.m0_clk

    add_interface           fpga_emif_reset   reset         sink
    set_interface_property  fpga_emif_reset   EXPORT_OF     hps_fpga_emif_cc_bridge.m0_reset

    add_interface           fpga_emif_avmm_m0   avalon      host
    set_interface_property  fpga_emif_avmm_m0   EXPORT_OF   hps_fpga_emif_cc_bridge.m0

    set_connection_parameter_value agilex_hps.hps2fpga/hps_address_span_extender.windowed_slave \
                    baseAddress $v_fpga_emif_window_base_address
    set_connection_parameter_value agilex_hps.hps2fpga/hps_address_span_extender.cntl \
    ...
    set_connection_parameter_value agilex_hps.hps2fpga/hps_address_span_extender.windowed_slave \
                    qsys_mm.burstAdapterImplementation {PER_BURST_TYPE_CONVERTER}
    set_connection_parameter_value hps_address_span_extender.expanded_master/hps_fpga_emif_cc_bridge.s0 \
                    qsys_mm.burstAdapterImplementation {PER_BURST_TYPE_CONVERTER}
    set_domain_assignment agilex_hps.hps2fpga qsys_mm.burstAdapterImplementation PER_BURST_TYPE_CONVERTER
    set_domain_assignment hps_address_span_extender.expanded_master \
                    qsys_mm.burstAdapterImplementation PER_BURST_TYPE_CONVERTER
    ...
    set_postadaptation_assignment mm_interconnect_2|\
                    hps_address_span_extender_cntl_burst_adapter.source0/\
                    hps_address_span_extender_cntl_agent.cp \
                    qsys_mm.postTransform.pipelineCount 1
    set_postadaptation_assignment mm_interconnect_2|\
                    hps_address_span_extender_windowed_slave_burst_adapter.source0/\
                    hps_address_span_extender_windowed_slave_agent.cp \
                    qsys_mm.postTransform.pipelineCount 1


    lock_avalon_base_address hps_address_span_extender.windowed_slave
    lock_avalon_base_address hps_address_span_extender.cntl
  ...
  if {(${v_irq_bridge_width} >= 1)} {
    ...
    for {set v_i 0} {${v_i} < ${v_irq_bridge_width}} {incr v_i} {
        ...
        if {${v_quartus_version} >= 24.3} {
            ...
            set_connection_parameter_value  agilex_hps.fpga2hps_interrupt_irq0/irq_bridge.sender${v_i}_irq irqNumber $v_priority
        } else { 
            add_connection  agilex_hps.fpga2hps_interrupt   irq_bridge.sender${v_i}_irq
            set_connection_parameter_value  agilex_hps.fpga2hps_interrupt/irq_bridge.sender${v_i}_irq irqNumber $v_priority
        }
    }
  ...
  # ------------------------------------------------------------
  # add modular-scatter-gather DMA

  if {${v_msgdma_en}} {

    add_instance  msgdma          altera_msgdma
    add_instance  msgdma_bridge   altera_avalon_mm_bridge

    # DMA settings

    set_instance_parameter_value  msgdma  MODE                              {0}
    set_instance_parameter_value  msgdma  DATA_WIDTH                        {32}
    set_instance_parameter_value  msgdma  USE_FIX_ADDRESS_WIDTH             {1}
    set_instance_parameter_value  msgdma  FIX_ADDRESS_WIDTH                 {38}
    set_instance_parameter_value  msgdma  EXPOSE_ST_PORT                    {0}
    set_instance_parameter_value  msgdma  DATA_FIFO_DEPTH                   {32}
    set_instance_parameter_value  msgdma  DESCRIPTOR_FIFO_DEPTH             {128}
    set_instance_parameter_value  msgdma  RESPONSE_PORT                     {2}
    set_instance_parameter_value  msgdma  MAX_BYTE                          {2147483647}
    set_instance_parameter_value  msgdma  TRANSFER_TYPE                     {Aligned Accesses}
    set_instance_parameter_value  msgdma  NO_BYTEENABLES                    {0}
    set_instance_parameter_value  msgdma  BURST_ENABLE                      {0}
    set_instance_parameter_value  msgdma  WRITE_RESPONSE_ENABLE             {1}

    # extended feature options

    set_instance_parameter_value  msgdma  ENHANCED_FEATURES                 {1}
    set_instance_parameter_value  msgdma  STRIDE_ENABLE                     {0}

    # pre-fetching options

    set_instance_parameter_value  msgdma  PREFETCHER_ENABLE                 {0}
    set_instance_parameter_value  msgdma  PREFETCHER_READ_BURST_ENABLE      {0}
    set_instance_parameter_value  msgdma  PREFETCHER_DATA_WIDTH             {32}
    set_instance_parameter_value  msgdma  PREFETCHER_MAX_READ_BURST_COUNT   {2}

    # msgdma_bridge

    set_instance_parameter_value  msgdma_bridge SYNC_RESET                  {0}

    set_instance_parameter_value  msgdma_bridge DATA_WIDTH                  {32}
    set_instance_parameter_value  msgdma_bridge SYMBOL_WIDTH                {8}

    set_instance_parameter_value  msgdma_bridge ADDRESS_WIDTH               {31}
    set_instance_parameter_value  msgdma_bridge USE_AUTO_ADDRESS_WIDTH      {0}
    set_instance_parameter_value  msgdma_bridge ADDRESS_UNITS               {SYMBOLS}

    set_instance_parameter_value  msgdma_bridge MAX_BURST_SIZE              {8}
    set_instance_parameter_value  msgdma_bridge LINEWRAPBURSTS              {0}

    set_instance_parameter_value  msgdma_bridge MAX_PENDING_RESPONSES       {4}
    set_instance_parameter_value  msgdma_bridge MAX_PENDING_WRITES          {0}
    set_instance_parameter_value  msgdma_bridge PIPELINE_COMMAND            {1}
    set_instance_parameter_value  msgdma_bridge PIPELINE_RESPONSE           {1}

    set_instance_parameter_value  msgdma_bridge USE_RESPONSE                {0}
    set_instance_parameter_value  msgdma_bridge USE_WRITERESPONSE           {0}

    add_connection  hps_axi_clk_bridge.out_clk    msgdma.clock
    add_connection  hps_axi_rst_bridge.out_reset  msgdma.reset_n
    add_connection  agilex_hps.lwhps2fpga         msgdma.csr
    add_connection  agilex_hps.lwhps2fpga         msgdma.descriptor_slave
    add_connection  agilex_hps.fpga2hps_interrupt msgdma.csr_irq
    add_connection  msgdma.mm_read                msgdma_bridge.s0
    add_connection  msgdma.mm_write               msgdma_bridge.s0

    add_connection  hps_axi_clk_bridge.out_clk    msgdma_bridge.clk
    add_connection  hps_axi_rst_bridge.out_reset  msgdma_bridge.reset

    add_connection  msgdma.mm_read                agilex_hps.fpga2hps
    add_connection  msgdma.mm_write               agilex_hps.fpga2hps

    add_interface           msgdma_m0   avalon      host
     set_interface_property  msgdma_m0   EXPORT_OF   msgdma_bridge.m0
...
proc edit_top_level_qsys {} {
  ...
  set_interface_property  "${v_instance_name}_i_usb31_phy_pma_cpu_clk" EXPORT_OF ${v_instance_name}.agilex_hps_usb31_phy_pma_cpu_clk

  add_interface           "${v_instance_name}_i_usb31_phy_refclk_p" clock sink
  set_interface_property  "${v_instance_name}_i_usb31_phy_refclk_p" EXPORT_OF ${v_instance_name}.agilex_hps_usb31_phy_refclk_p

  add_interface           "${v_instance_name}_i_usb31_phy_refclk_n" clock sink
  set_interface_property  "${v_instance_name}_i_usb31_phy_refclk_n" EXPORT_OF ${v_instance_name}.agilex_hps_usb31_phy_refclk_n

  add_interface           "${v_instance_name}_i_usb31_phy_rx_serial_p" conduit end
  set_interface_property  "${v_instance_name}_i_usb31_phy_rx_serial_p" EXPORT_OF ${v_instance_name}.agilex_hps_usb31_phy_rx_serial_p

  add_interface           "${v_instance_name}_i_usb31_phy_rx_serial_n" conduit end
  set_interface_property  "${v_instance_name}_i_usb31_phy_rx_serial_n" EXPORT_OF ${v_instance_name}.agilex_hps_usb31_phy_rx_serial_n

  add_interface           "${v_instance_name}_o_usb31_phy_tx_serial_p" conduit end
  set_interface_property  "${v_instance_name}_o_usb31_phy_tx_serial_p" EXPORT_OF ${v_instance_name}.agilex_hps_usb31_phy_tx_serial_p

  add_interface           "${v_instance_name}_o_usb31_phy_tx_serial_n" conduit end
  set_interface_property  "${v_instance_name}_o_usb31_phy_tx_serial_n" EXPORT_OF ${v_instance_name}.agilex_hps_usb31_phy_tx_serial_n
...
if {${v_quartus_version} >= 24.3} {
    ...
    set_interface_property  "${v_instance_name}_c_emif_mem_reset_n" export_of ${v_instance_name}.agilex_hps_emif_mem_reset_n
  ...
  set_interface_property  "${v_instance_name}_agilex_hps_i2c1_scl_i"   export_of  ${v_instance_name}.agilex_hps_i2c1_scl_i

  add_interface           "${v_instance_name}_agilex_hps_i2c1_scl_oe"  clock      sink
  set_interface_property  "${v_instance_name}_agilex_hps_i2c1_scl_oe"  export_of  ${v_instance_name}.agilex_hps_i2c1_scl_oe

  add_interface           "${v_instance_name}_agilex_hps_i2c1"         conduit    end
  set_interface_property  "${v_instance_name}_agilex_hps_i2c1"         export_of  ${v_instance_name}.agilex_hps_i2c1
...
proc add_auto_connections {} {
  ...
  if {(${v_ai_en} == 1) && (${v_hps_ai_bbf} == 1)} {
    add_auto_connection   ${v_instance_name} ai_res_out_m_vid_axis       hps_f2sdram
  ...
  if {${v_drv_msgdma_en}} {
    set v_msgdma_agent  [get_shell_parameter MSGDMA_AGENT]
    add_auto_connection ${v_instance_name msgdma_m0} "${v_msgdma_agent}_user_data"
  }
...
if {${v_quartus_version} >= 24.3} {
    add_qsys_inst_exports_list    "${v_instance_name}_c_emif_mem_ck_mem_ck_t"      hps_mem_ck_t
    add_qsys_inst_exports_list    "${v_instance_name}_c_emif_mem_ck_mem_ck_c"      hps_mem_ck_c
} else {
    add_qsys_inst_exports_list    "${v_instance_name}_c_emif_mem_mem_ck_t"      hps_mem_ck_t
    add_qsys_inst_exports_list    "${v_instance_name}_c_emif_mem_mem_ck_c"      hps_mem_ck_c
}
...
if {${v_quartus_version} >= 24.3} {
    ...
    add_qsys_inst_exports_list    "${v_instance_name}_c_emif_mem_mem_reset_n"   hps_mem_reset_n
}
  ...
  add_qsys_inst_exports_list    "${v_instance_name}_c_emif_mem_mem_dqs_t"     hps_mem_dqs_t
  add_qsys_inst_exports_list    "${v_instance_name}_c_emif_mem_mem_dqs_c"     hps_mem_dqs_c

  if {${v_cam_i2c_en} != 0} {
    add_qsys_inst_exports_list     "${v_instance_name}_agilex_hps_i2c1_scl_i_clk"    cam_i2c_scl_in
    add_qsys_inst_exports_list     "${v_instance_name}_agilex_hps_i2c1_scl_oe_clk"   cam_i2c_scl_oe
    add_qsys_inst_exports_list     "${v_instance_name}_agilex_hps_i2c1_sda_i"        cam_i2c_sda_in
    add_qsys_inst_exports_list     "${v_instance_name}_agilex_hps_i2c1_sda_oe"       cam_i2c_sda_oe
  }
}